...
hero:
  ...
  actions:
    - text: Get started
      link: /dzl/overview/what-is-dzl/
      icon: right-arrow
    - text: View on GitHub
      link: https://github.com/Borcioo/dzl
      icon: external
      variant: minimal
    - text: Download
      link: https://github.com/Borcioo/dzl/releases
      icon: down-arrow
      variant: minimal
---
...
[See how it fits together →](/dzl/overview/the-big-idea/)
